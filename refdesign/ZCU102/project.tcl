...
#
# Generated by Vivado on Wed Oct 02 11:01:58 +0200 2019
...
#
#    "D:/gfa/Libraries/Firmware/VivadoIp/vivadoIp_i2c_devreg/refdesign/ZCU102/RefDesign/RefDesign.srcs/sources_1/imports/hdl/system_wrapper.vhd"
#
# 3. The following remote source files that were added to the original project:-
#
#    "d:/gfa/Libraries/Firmware/VivadoIp/vivadoIp_i2c_devreg/refdesign/ZCU102/src/system_wrapper.vhd"
#    "D:/gfa/Libraries/Firmware/VivadoIp/vivadoIp_i2c_devreg/refdesign/ZCU102/constraints/pinout.xdc"
#
#*****************************************************************************************
...
proc cr_bd_system { parentCell } {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
psi.ch:PSI:i2c_devreg:*\
psi.ch:PSI:i2c_devreg_refdes_rom:*\
...
proc create_hier_cell_proc { parentCell nameHier } {
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins peripheral_resetn] [get_bd_pins axi_reset/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins pl_clk0] [get_bd_pins axi_reset/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins axi_reset/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  # Create ports
  set I2cScl [ create_bd_port -dir IO I2cScl ]
  set I2cSda [ create_bd_port -dir IO I2cSda ]
  ...
  # Create instance: i2c_devreg_0, and set properties
  set i2c_devreg_0 [ create_bd_cell -type ip -vlnv psi.ch:PSI:i2c_devreg i2c_devreg_0 ]
  set_property -dict [ list \
   CONFIG.UpdatePeriodMs_g {1000} \
 ] $i2c_devreg_0

  # Create instance: i2c_devreg_refdes_rom_0, and set properties
  set i2c_devreg_refdes_rom_0 [ create_bd_cell -type ip -vlnv psi.ch:PSI:i2c_devreg_refdes_rom i2c_devreg_refdes_rom_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins i2c_devreg_0/s00_axi]
  connect_bd_intf_net -intf_net i2c_devreg_0_I2cRom [get_bd_intf_pins i2c_devreg_0/I2cRom] [get_bd_intf_pins i2c_devreg_refdes_rom_0/I2cRom]
  connect_bd_intf_net -intf_net i2c_devreg_refdes_rom_0_RomI2c [get_bd_intf_pins i2c_devreg_0/RomI2c] [get_bd_intf_pins i2c_devreg_refdes_rom_0/RomI2c]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports I2cScl] [get_bd_pins i2c_devreg_0/I2cScl]
  connect_bd_net -net Net1 [get_bd_ports I2cSda] [get_bd_pins i2c_devreg_0/I2cSda]
  connect_bd_net -net i2c_devreg_0_Irq [get_bd_pins i2c_devreg_0/Irq] [get_bd_pins proc/pl_ps_irq0]
  connect_bd_net -net proc_peripheral_resetn [get_bd_pins i2c_devreg_0/s00_axi_aresetn] [get_bd_pins proc/peripheral_resetn]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins proc/intercon_resetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins i2c_devreg_0/UpdateTrig] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins i2c_devreg_0/s00_axi_aclk] [get_bd_pins i2c_devreg_refdes_rom_0/aclk] [get_bd_pins proc/pl_clk0]

  # Create address segments
  create_bd_addr_seg -range 0x00004000 -offset 0x80000000 [get_bd_addr_spaces proc/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs i2c_devreg_0/s00_axi/reg0] SEG_i2c_devreg_0_reg0
